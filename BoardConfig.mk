...
TARGET_PREBUILT_KERNEL := device/Infinix/X522/kernel/kernel
...
# Assert
TARGET_OTA_ASSERT_DEVICE := Infinix,X522,Infinix S2,H539,Infinix X522
...
BOARD_HARDWARE_CLASS := device/Infinix/X522/cmhw
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/Infinix/X522/bluetooth

TARGET_LDPRELOAD += mtk_symbols.so

# CWM
TARGET_RECOVERY_FSTAB := device/Infinix/X522/rootdir/recovery.fstab
...
TARGET_SYSTEM_PROP := device/Infinix/X522/system.prop
TARGET_SPECIFIC_HEADER_PATH := device/Infinix/X522/include
