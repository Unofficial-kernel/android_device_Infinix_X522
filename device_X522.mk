...
LOCAL_PATH := device/Infinix/X522

$(call inherit-product-if-exists, vendor/Infinix/X522/X522-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/Infinix/X522/overlay
PRODUCT_PACKAGE_OVERLAYS += device/Infinix/X522/overlay 
...
PRODUCT_BUILD_PROP_OVERRIDES += BUILD_FINGERPRINT=Infinix/H539/Infinix-X522:7.0/NRD90M/X522-H539A-N-170816V187:user/release-keys
PRODUCT_BUILD_PROP_OVERRIDES += PRIVATE_BUILD_DESC="full_rlk6753_65_n-user 7.0 NRD90M 1502824225 release-keys"
